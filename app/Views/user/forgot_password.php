    	...
    	<div class="login_info">
        	<div class="row g-0">
                ...
                <div class="col-xl-7 col-lg-6 col-md-7">					
                    <form class="form_info" action="<?php echo base_url(); ?>forgot-password" method="post" id="forgotpassword">
						...
						<?php endif; ?>
                    	<h2 class="title font_lato"><small>Forgot</small> Forgot your password?</h2>
                        <p>No problem, we’ll send instructions to your inbox to reset your password. </p>
                        <div class="row">
