        ...
        <div class="profile_content">
            ...
            <div class="breadcrumb_info">
                <ul>
                    ...
                    <li>Update KYC Documents</li>
                </ul>
            </div>
            
            <!-- Title -->
            <h2 class="title">Update KYC Documents  <?php //echo $name; ?></h2>
            ...
            <ul class="nav nav-tabs profile_tabs" id="myTab1" role="tablist">
                <li class="nav-item" role="presentation">
                	<button class="nav-link active" id="personal-tab" data-bs-toggle="tab" data-bs-target="#personal" type="button" role="tab" aria-controls="personal" aria-selected="true">
                        ...
                        <span>Upload <?php echo $kyc_document?></span>
                    </button>
                </li>
                            ...
                            <div id="pane-A" class="card tab-pane fade show active" role="tabpanel" aria-labelledby="tab-A">
                                ...
                                <div id="collapse-A" class="collapse show" data-bs-parent="#content" role="tabpanel" aria-labelledby="heading-A">
                                    <div class="card-body">
                                    	...
                                    	<input type="hidden" class="form-control" name="document_id" id="document_id" value="<?php echo $documents[$kyc_document];?>" >
										<div class="row">
										<?php if($kyc_document=='Id Proof'){?>
										<div id="div_id_proof">
